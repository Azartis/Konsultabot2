"""
Django settings for konsultabot_backend project.
"""
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '192.168.1.11', '192.168.1.17', '192.168.1.25', '192.168.110.17', '0.0.0.0']
...
ROOT_URLCONF = 'konsultabot_backend.urls'
...
WSGI_APPLICATION = 'konsultabot_backend.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': BASE_DIR / 'konsultabot.db',
    }
}
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://192.168.110.17:8081",
    "exp://192.168.1.11:8081",
    "exp://192.168.1.25:8081",
    "exp://192.168.110.17:8081",
]
